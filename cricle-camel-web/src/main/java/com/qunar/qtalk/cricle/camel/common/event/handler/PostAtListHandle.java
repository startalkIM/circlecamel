...
@Slf4j
@Component
public class PostAtListHandle extends BaseEventHandler {
    @Resource
    ...
    public boolean handleMessage(CamelMessage camelMessage) {
        try {
            log.info("post at message save into the db，camelMessage:{}",JSON.toJSONString(camelMessage));
    ...
    public List<EventType> getSupportEventTypes() {
        return Arrays.asList(EventType.ATREMINDPOST);
    }
}
